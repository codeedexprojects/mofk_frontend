...
const SearchSecondCarousel = ({ setAdminCarousel }) => {
    ...
    useEffect(() => {
        const handleSearchCarousel = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/admin/carousel/search?name=${searchCarousel}`, {
                    headers: {
...
export default SearchSecondCarousel
