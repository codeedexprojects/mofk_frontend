...
const EditSecondCarousel = ({ initialEditCarouselData, setAdminCarousel }) => {
    ...
    const fetchAdminCarousel = async () => {
        try {
            const response = await axios.get(`${BASE_URL}/admin/carousel`);
    ...
    const handleEditCarouselSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.patch(`${BASE_URL}/admin/carousel/${initialEditCarouselData._id}`, editCarouselFormData, { headers })
...
export default EditSecondCarousel
