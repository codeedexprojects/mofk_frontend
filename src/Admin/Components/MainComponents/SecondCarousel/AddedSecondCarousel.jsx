...
const AddedSecondCarousel = ({ createEditCarousel, handleEditCarousel, adminCarousel, setAdminCarousel }) => {
    ...
    const handleCarouselDelete = async (carouselId) => {
        try {
            ...
            const response = await axios.delete(`${BASE_URL}/admin/carousel/${carouselId}`, { headers });
            console.log(response.data);
            handleOpen()
...
export default AddedSecondCarousel
