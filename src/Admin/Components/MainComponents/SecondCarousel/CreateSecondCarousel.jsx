...
const CreateSecondCarousel = ({ setAdminCarousel }) => {
    ...
    const handleCarouselSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${BASE_URL}/admin/carousel/create`, carouselFormData, { headers });
...
export default CreateSecondCarousel;
