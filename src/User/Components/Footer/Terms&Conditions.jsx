    ...
    return (
        <>
            <div className="py-10 px-6 md:px-20 lg:px-40">
                ...
                <p className="mb-4">
                    The materials appearing on the website could include technical, typographical, or photographic errors. MOFK COLLECTIONS does not warrant that any of the materials on its website are accurate, complete, or current. The materials, contents, and photos on the site can be changed at any time without notice.
                </p>

                <h2 classNam e="text-lg font-semibold mb-2">2. Links</h2>
                <p className="mb-4">
                    MOFK COLLECTIONS has not reviewed all of the sites linked to its Internet web site and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement. Use of any such linked web site is at the user's own risk.
                </p>

                <h2 className="text-lg font-semibold mb-2">3. Site Terms of Use Modifications</h2>
                <p className="mb-4">
                    MOFK COLLECTIONS have the right to revise these terms of use for its web site at any time without notice. By using this web site you are agreeing to be bound by the then current version of these Terms and Conditions of Use.
                </p>
                ...
                <p className="mb-4">
                    Any claim relating to the website of MOFK COLLECTIONS shall be governed by the laws of the State of Kerala without regard to its conflict of law provisions.
                </p>
